	...
	<tr>
		<td class="publication">
			<span class="pubtitle">
				...
				<a href="None">Leveraging campus-scale Wi-Fi data for activity-based occupant modeling in urban energy applications</a>
			</span><br />
			<span class="authors">
	...
	<tr>
		<td class="publication">
			<span class="pubtitle">
				...
				<a href="None">The Building Data Genome Directory – An open, comprehensive data sharing platform for building performance research</a>
			</span><br />
			<span class="authors">
	...
	<tr>
		<td class="publication">
			<span class="pubtitle">
				...
				<a href="None">Utilizing wearable technology to characterize and facilitate occupant collaborations in flexible workspaces</a>
			</span><br />
			<span class="authors">
