...
bibtex2html --revkeys --sort-by-date -r --no-abstract -nobibsource --no-keywords -o _pages/publications ~/Dropbox/MendeleyBibTeX/Publications.bib
...
# TODO: generate the bib file into a separated plain html in the jekyll environment
